...
public class FindLocalMinima 
{
    ...
    public static void main (String[] args) 
    {
        ...
        int arr2[]= {101,11,23, 80, 15, 2, 3};
        System.out.println("Index of a local minima is " + localMin(arr2, arr2.length));
        
        int arr3[]= {1, 23, 15, 2, 3};
        System.out.println("Index of a local minima is " + localMin(arr3, arr3.length));
